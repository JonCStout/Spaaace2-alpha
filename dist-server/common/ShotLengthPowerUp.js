...
var ShotLengthPowerUp =
/*#__PURE__*/
function (_DynamicObject) {
  _inherits(ShotLengthPowerUp, _DynamicObject);

  function ShotLengthPowerUp(gameEngine, options, props) {
    _classCallCheck(this, ShotLengthPowerUp);

    return _possibleConstructorReturn(this, _getPrototypeOf(ShotLengthPowerUp).call(this, gameEngine, options, props));
  ...
  _createClass(ShotLengthPowerUp, [{
    key: "onAddToWorld",
    value: function onAddToWorld(gameEngine) {
      if (_lanceGg.Renderer) {
        var renderer = _lanceGg.Renderer.getInstance();

        var sprite = new PIXI.Sprite(PIXI.loader.resources.shotLengthPowerUp.texture);
    ...
    value: function syncTo(other) {
      _get(_getPrototypeOf(ShotLengthPowerUp.prototype), "syncTo", this).call(this, other);
    ...
    get: function get() {
      ...
      }, _get(_getPrototypeOf(ShotLengthPowerUp), "netScheme", this));
    }
  }]);

  return ShotLengthPowerUp;
}(_lanceGg.DynamicObject);

exports["default"] = ShotLengthPowerUp;
//# sourceMappingURL=ShotLengthPowerUp.js.map